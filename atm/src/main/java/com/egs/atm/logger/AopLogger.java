...
public class AopLogger {
    ...
    @Before("execution(* com.egs.atm..service..*(..)) ")
    ...
    @Before("execution(* com.egs.atm..controller..*(..)) ")
    ...
    @AfterThrowing(value = "execution(* com.egs.atm..controller..*(..)) ", throwing = "e")
    ...
    @AfterThrowing(value = "execution(* com.egs.atm..service..*(..)) ", throwing = "e")
    public void logServiceError(JoinPoint joinPoint, Throwable e) {
        logger.logStackTrace(e);
        logger.eventLogger.error(joinPoint.getSignature().getName() + " error:" + e.getMessage());
    }

    @AfterReturning(value = "execution(* com.egs.atm..service..*(..)) ", returning = "returnValue")
    ...
    @AfterReturning(value = "execution(* com.egs.atm..controller..*(..)) ", returning = "returnValue")
